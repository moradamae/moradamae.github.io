const INFO_MAES = [
  ...
  },
  {
    ...
    nombre: 'NIC MOTTA',
    imagen: '',
    video: 'https://www.youtube.com/embed/IHtt-9gYi_M',
    titulo: 'data_nec',
    texto: `data_nec es un clon de mi mismo. Capaz de comunicarse textual y sonoramente a través de mezclas de sonidos y corporizarse en una estructura digital / exoesqueleto derivada de datos procesados.
    <br>
    <br>
    ...
    <br>
    <a href="https://nicmotta.github.io/eje_espacio/">Ir a la bitácora</a>
    `
  },
  {
    right: false,
...
`
  ...
  },
  {
    ...
    imagen: '',
    video: 'https://www.youtube.com/embed/iDCHhJv8yts',
    titulo: 'Jauleria',
    texto: `
    ...
    <br>
    <a href="https://drive.google.com/drive/folders/1TBkxcKWF8yDzqEalJ0FmWyS-kz5dWoEn?usp=sharing">Versión Mac</a>
    `
  },
  {
    right: false,
  ...
  if(Array.isArray(element) && !infoLocal) {
    index_html = `
      <div class="container">
        ...
        <div class="img-fondo">
          ...
          <div id="container-info" class="container-info izquierda">
            ${
              INFO_MAES.slice(5, 10).map(item => {
                return`
                  <div onclick="redirect('${item.id}')" class="info">
                    <p>${item.nombre}</p>
                  </div>
          ...
          <div id="container-info" class="container-info izquierda-afuera">
            ${
              INFO_MAES.slice(10, 14).map(item => {
                return`
                  <div onclick="redirect('${item.id}')" class="info">
                    <p>${item.nombre}</p>
                  </div>
          ...
          <div id="container-info" class="container-info derecha-afuera">
            ${
              INFO_MAES.slice(14, 18).map(item => {
                return`
                  <div onclick="redirect('${item.id}')" class="info">
                    <p>${item.nombre}</p>
                  </div>
    ...
    index_html = `
      <div class='container-detalle ${element.right ? "" : "left"}'>
        ...
        <div class="info-obra">
          ${elementInfo.video ? `<iframe class="imagen" src=${elementInfo.video}> </iframe>`
            : `<img class="imagen" src="${elementInfo.imagen}"/>`
          }
